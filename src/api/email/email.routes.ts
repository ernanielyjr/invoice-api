...
class EmailRoutes {
  public config(app): void {
    app.route('/api/v1/email/unsent').get(EmailController.listUnsent.bind(EmailController));
    app.route('/api/v1/email/send-all').get(EmailController.sendAll.bind(EmailController));
